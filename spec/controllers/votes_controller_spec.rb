...
RSpec.describe VotesController, type: :controller do
   ...
   let(:my_vote) { create(:vote, post: user_post, user: my_user) }
    ...
    #unsigned-in users cannot vote and are redirected ot the sign-in page
    context "guest" do
    ...
    #create the context and expected behavior for signed-in users
    context "signed in user" do
     ...
     describe "POST up_vote" do
         it "the users first vote increases number of post votes by one" do
            ...
            #ensure user is directed back to correct view (post show or topics show)
            #depending on which view they up voted from by setting "HTTP_REFERER"
