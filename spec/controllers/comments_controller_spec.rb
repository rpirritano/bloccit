...
RSpec.describe CommentsController, type: :controller do
    ...
    # tests that guest users will be directed to teh sign in if try to create/delete a comment
    context "guest" do
    ...
    #Test members CRUD for comment they dont own.  They can create new, but direct to show if try to delete
